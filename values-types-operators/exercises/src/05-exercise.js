/**
 * Create multiple variables to learn the values that
...
export function learnConsoleLog() {
  ...
  console.log(200);
  let printLog = 100;
  console.log(`Use template literal to print: ${printLog}`);
}

/**
 * 2. Create a variable containing a string
...
/**
 * 3. Create a variable containing a number
 * and use console.log(typeof(variableName))
 * to see the result.
 *
 * You can use any name for the variable.
...
/**
 * 4. Create a variable containing a boolean
 * and use console.log(typeof(variableName))
 * to see the result.
 *
 * You can use any name for the variable.
...
/**
 * 7. Create a variable containing an array
 * and use console.log(typeof(variableName))
 * to see the result.
 *
 * You can use any name for the variable.
...
export function arrTypeofTest() {
  // Write your code bellow this line
  console.log(typeof (['string', 100, undefined, null]));
}
